 ...
 * @since Feb 7, 2013
 */
public class ModeShapeRepositoryFactoryBeanBundle implements
        FactoryBean<FedoraRepository> {

    private static final Logger LOGGER =
            getLogger(ModeShapeRepositoryFactoryBeanBundle.class);
    ...
    public void buildRepository() {
        try {
            LOGGER.info("Using repo config (classpath): {}", repositoryConfiguration);
            getPropertiesLoader().loadSystemProperties();

            final RepositoryConfiguration config =
                    RepositoryConfiguration.read(repositoryConfiguration);
    ...
    public void setRepositoryConfiguration(
            final String repositoryConfiguration) {
