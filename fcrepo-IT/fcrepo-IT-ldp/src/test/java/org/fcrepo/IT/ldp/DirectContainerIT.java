...
public class DirectContainerIT extends org.fcrepo.IT.ldp.FcrepoLdpTestSuite {
    ...
    public void before() {
        ...
        final String container = RestAssured
                ...
                .header(HttpHeaders.LINK, Link.fromUri(String.valueOf(LDP.DirectContainer)).rel
